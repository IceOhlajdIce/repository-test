...
set JAVAOPTS=-Denv.windir=%WINDIR% -Djavax.xml.transform.TransformerFactory=net.sf.saxon.TransformerFactoryImpl -Djava.net.preferIPv4Stack=true
...
"%JAVACMD%" -Xrs %JAVAOPTS% %LOGCHOICE% %LOGLEVEL% -cp "%LOCALCLASSPATH%";. com.intersys.zenreports.RenderServer -render FOP %*
